 ...
 * 
 */
package pl.pikopl.openwro.weather.dbservice.configuration;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = { "pl.pikopl.openwro.weather.dbservice.repository" })
...
public class PersistenceConfig {
	...
	public EntityManagerFactory entityManagerFactory(final DataSource dataSource, final Environment env) {
		...
		entityManagerFactoryBean.setPackagesToScan("pl.pikopl.openwro.weather.dbservice");
