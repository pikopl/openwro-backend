 ...
 * 
 */
package com.xaltome.smartcity.weather.dbservice.configuration;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = { "com.xaltome.smartcity.weather.dbservice.repository" })
...
public class PersistenceConfig {
	...
	public EntityManagerFactory entityManagerFactory(final DataSource dataSource, final Environment env) {
		...
		entityManagerFactoryBean.setPackagesToScan("com.xaltome.smartcity.weather.dbservice");
